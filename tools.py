...
MOP_res_columns = ["alpha", "tot_oil"]+[w+"_choke" for w in wellnames_2]+[w+"_gas_mean" for w in wellnames_2]+[w+"_oil_mean" for w in wellnames_2]+[w+"_gas_var" for w in wellnames_2]+[w+"_oil_var" for w in wellnames_2]
